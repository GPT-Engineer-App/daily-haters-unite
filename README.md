...
**Project**: daily-haters-unite 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Please create a humorous landing page for a Daily Haters church? It should be witty and indicate the non-essesity of the every day team-wide communication. Regular syncs between coworkers is necesary, but dailys that frequently extend 2x of the planned time aren't. People aren't listening to each other and it's boring. 
...
```sh
git clone https://github.com/GPT-Engineer-App/daily-haters-unite.git
cd daily-haters-unite
npm i
